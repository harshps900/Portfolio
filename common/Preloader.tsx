...
export default function Preloader() {
    ...
    const statuses = [
        ...
        "COMPILING ANIMATION CACHES...",
        "TRANSFERRING ASSETS TO GPU MEMORY...",
        "SYSTEM ONLINE"
    ];
    ...
    useEffect(() => {
        ...
        const tick = (now: number) => {
            ...
            // Change status text directly based on percentage
            if (percentage < 20) {
                setStatusIndex(0);
    ...
    return (
        !isComplete ? (
            <div
                className={`fixed inset-0 z-50 flex flex-col items-center justify-center bg-[#fbfaf7] text-[#1c1b1a] select-none transition-all duration-[950ms] ease-[cubic-bezier(0.76,0,0.24,1)] ${
                    isFadingOut ? "opacity-0 pointer-events-none scale-[0.98] blur-sm" : "opacity-100"
                }`}
            >
